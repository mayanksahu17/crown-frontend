          ...
          <div className="global-container">
            <div className="grid items-center gap-10 md:grid-cols-[minmax(0,_1fr)_1.3fr] lg:gap-[60px] xl:gap-x-[94px]">
              <div className="jos" data-jos_animation="fade-left">
                ...
                <h1 className="font-raleway text-6xl">Physical Card</h1>
                <div className="flex mt-2 flex-row gap-4">
                  <p className="mb-8 text-lg leading-[1.33] last:mb-0 mt-4">
                    Spend globally, online or offline, at 1 million+ merchants.
                    Utilize cards to unleash the power of your crypto assets,
                    offering limitless flexinility and cash access anytime,
                    anywhere. A physical card will be given to users who
                    activate a single package of $20,000 or more
                  </p>
                </div>
              </div>
              <div className="jos" data-jos_animation="fade-right">
                <img
                  src="assets/img/plan/14.png"
                  alt="hero-img"
