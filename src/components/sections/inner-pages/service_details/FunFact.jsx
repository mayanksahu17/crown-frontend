        ...
        <div className='jos grid grid-cols-1 overflow-hidden rounded-[30px] bg-black lg:rounded-[50px] xl:grid-cols-[minmax(400px,_1fr)_1.5fr] xxl:grid-cols-[1fr_minmax(800px,_1fr)]'>
          ...
          <div className='self-center px-6 py-16 sm:py-20 md:px-16 xl:px-10 xl:py-24 xxl:py-32 xxl:pl-16 xxl:pr-28'>
            ...
            <div className='mb-8 lg:mb-16 xl:mb-6'>
              <h2 className='text-white'>Crafting a Vision for Financial Excellence</h2>
            </div>
            {/* Section Content Block */}
            <div className='text-left text-lg leading-[1.4] text-white lg:text-[21px]'>
              <p className='mb-7 last:mb-0'>
              At Crown Bankers, we envision reshaping financial excellence through innovative solutions and strategic investments. Trailblazing opportunities for growth and stability, we empower clients to navigate evolving markets with confidence. Our commitment to a prosperous future drives every financial decision, ensuring security and success for our clients.              </p>
            </div>
