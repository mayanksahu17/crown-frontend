          ...
          <div className='global-container'>
            <div className='grid grid-cols-1 items-center gap-12 md:grid-cols-2 xl:grid-cols-[minmax(0,_1.2fr)_1fr] xl:gap-28'>
              ...
              <div className='jos order-1' data-jos_animation='fade-right'>
                ...
                <br/>
                <div>
                  <h3 style={{fontSize:"30px"}}>Charge Up Your Portfolio: The Electrifying EV Revolution</h3>
                </div>
                <br/>
                <br/>
                ...
                <ul className='mt-8 grid gap-x-6 gap-y-8 sm:grid-cols-2 md:grid-cols-1 xl:mt-14 xl:grid-cols-2'>
                  <li className='flex flex-col gap-y-4'>
                    ...
                    <p className='text-lg'>
                    The global EV market is expected to hit $1.8 trillion by 2030.
                    </p>
                  </li>
                  <li className='flex flex-col gap-y-4'>
                    <div className='h-[50px] w-[50px]'>
                    ...
                    <p className='text-lg'>
                    EVs are leading the shift towards sustainable transportation.  
                    </p>
                  </li>
                </ul>
                <br />
                ...
                <ul className='mt-8 grid gap-x-6 gap-y-8 sm:grid-cols-2 md:grid-cols-1 xl:mt-14 xl:grid-cols-2'>
                  <li className='flex flex-col gap-y-4'>
                    ...
                    <p className='text-lg'>
                     From Tesla and General Motors to innovative battery tech companies.
